                ...
                <div class="tab-content">
                    <div class="tab-pane  active" id="tab1">
                        ...
                        <div class="col-lg-4 text-center">
                            ...
                            <form id="form-create-empleado" style="padding:0px 15px;" class="form-horizontal" role="form" action="<?php base_url(); ?>empleados/guardar" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="file" name="foto_empleado">
                                </div>
                                <div class="form-group">
